...
src_prepare() {
	...
	# Override or remove deprecated patches
	cp -f "${FILESDIR}/0001-Don-t-use-build-id.patch" "${WORKDIR}/firefox-patches" || die
	rm "${WORKDIR}/firefox-patches/0013-musl-include-net-if.h-before-linux-if.h-to-avoid-red.patch"
	rm "${WORKDIR}/firefox-patches/0028-bmo-1775202-ppc64-webrtc-missing-conditions-109.patch"
